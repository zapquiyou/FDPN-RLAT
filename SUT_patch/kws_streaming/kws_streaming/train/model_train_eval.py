...
def main(_):
  ...
  steps = flags.how_many_training_steps.split(',')[0]
  result_file_path = flags.result_file_path + flags.model_name + '_' + steps + '_' + 'testing.json'
  test.tf_non_stream_model_accuracy(flags, folder_name, result_file_path=result_file_path, test_set="testing")
  result_file_path = flags.result_file_path + flags.model_name + '_' + steps + '_' + 'rl_train.json'
  test.tf_non_stream_model_accuracy(flags, folder_name, result_file_path=result_file_path, test_set="rl_train")
